...
namespace DAL.Interface
{
    public interface ISQLRepository
    {
        ...
        Task InsertEntriesAsync(string tableName, Contest contest, Dictionary<string, object> props, IEnumerable<ColumnMetadata> tableColumns, IDbContextTransaction transaction);
        ...
        Task<List<Dictionary<string, object>>> PickWinners(string tableName, PickWinnerModel option, IDbContextTransaction transaction);
        ...
        Task<List<Dictionary<string, object>>> FindDataAsync(string tableName, Dictionary<string, object> props, List<ColumnMetadata> tableColumns, IDbContextTransaction transaction);
        Task<List<ColumnMetadata>> GetTableColumnsAsync(string contestUniqueCode, IDbContextTransaction transaction);
        Task InsertWinnersAsync(string tableName, Dictionary<string, object> props, List<ColumnMetadata> tableColumns, IDbContextTransaction transaction);
    }
}
